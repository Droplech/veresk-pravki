            ...
            $(document).on('click', '.quick-wiew-button', function () {
                ...
                $.magnificPopup.open({
                    ...
                    items: {
                        ...
                        src: '<div class=kt-popup-quickview><div class=details-thumb><div class="slider-for slider-product"><div class=details-item><img alt=img src=assets/images/popup-quickview-item-1.jpg></div><div class=details-item><img alt=img src=assets/images/popup-quickview-item-1.jpg></div><div class=details-item><img alt=img src=assets/images/popup-quickview-item-1.jpg></div><div class=details-item><img alt=img src=assets/images/popup-quickview-item-1.jpg></div></div><div class="nav-center slider-nav slider-product-button"><div class=details-item><img alt=img src=assets/images/popup-quickview-item-1.jpg></div><div class=details-item><img alt=img src=assets/images/popup-quickview-item-1.jpg></div><div class=details-item><img alt=img src=assets/images/popup-quickview-item-1.jpg></div><div class=details-item><img alt=img src=assets/images/popup-quickview-item-1.jpg></div></div></div><div class=details-infor><h1 class=product-title>Ель обыкновенная</h1><div class=availability>Размер сажанца: 40см</div><div class=availability>Артикул:</div><div class=group-button><div class=quantity-add-to-cart><div class=quantity><div class=control><a href=# class="btn-number qtyminus quantity-minus">-</a><input class="input-qty qty"data-min=0 data-step=1 size=4 title=Qty value=1><a href=# class="btn-number qtyplus quantity-plus">+</a></div></div><button class="button single_add_to_cart_button">В корзину</button></div><div class=price><span>21 BYN</span></div><div class=bonuses><div class=bonuses_icon><a href=""><i class=icon-credit-card></i></a></div><p class=bonuses_txt>Бонусы:<div class=bonuses_price><p>24.5</div></div><div class=yith-wcwl-add-to-wishlist><div class=yith-wcwl-add-button><a href=#>Избранное</a></div></div><div class=size-chart-wrapp><div class=btn-size-chart><a href=""class=fancybox id=size_chart><i class=icon-camera></i> Запросить фото<br>растения</a></div></div></div><div class=product-details-description><div class=availability>Параметры:</div><ul><li><div class=information_icon><img alt=""src=assets/images/icon_charact/высота_растения.png></div>Размер: 1метр<li><div class=information_icon><img alt=""src=assets/images/icon_charact/время_цветения.png></div>Срок цветения: май-август<li><div class=information_icon><img alt=""src=assets/images/icon_charact/расположение.png></div>Расположение: тень</ul></div></div></div>',
